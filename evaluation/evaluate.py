...
def main() -> dict[Any, Any]:
    ...
    parser.add_argument(
        "--submission",
        type=Path,
        default=Path(SUBMISSION_FOLDER, "test.tsv"),
    ...
    parser.add_argument(
        ...
        type=str,
        default= "Duplicate",
        help="Saved .csv file name. Do not include .csv suffix"
    ...
    results.reset_index().to_csv(f"results/{args.save_name}.csv", index=False)
